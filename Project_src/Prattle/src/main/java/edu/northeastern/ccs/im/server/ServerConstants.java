...
public class ServerConstants {
     ...
     */
    static final int PORT = 4505;

    /**
     * Name of the private user who responds to interesting queries.
     */
    private static final String NIST_NAME = "NIST";
     ...
     */
    static final String BOUNCER_ID = BOUNCER_NAME;

    /**
     * Private user who responds to interesting queries.
     */
    private static final String NIST_ID = NIST_NAME;
     ...
     */
    static final String BOMB_TEXT = "Prattle says everyone log off";
     ...
     */
    static List<Message> getBroadcastResponses(String message) {
