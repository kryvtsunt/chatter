...
class ClientRunnableTest {
    ...
    void setUp() throws IOException {
        ...
        msgs.add(Message.makeSimpleLoginMessage("TooDumbToEnterRealUsername"));
        msgs.add(Message.makeSimpleLoginMessage("BOUNCER"));
        msgs.add(Message.makeBroadcastMessage("abcd",""));
